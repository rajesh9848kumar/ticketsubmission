...
<html>
 ...
 <input type=hidden name="flag" id="flag" value="<%=(session.getAttribute("flag")==null)?null:session.getAttribute("flag")%>">
   <header>
		...
		<div id="nav">
				<ul>
					<li><a href="tech_home.jsp" class="active">Home</a></li>
					<li><a href="new_ticket.jsp">New Tickets</a></li>
  ...
  <section>
	<% 
			...
			ResultSet rs=st.executeQuery("select u.name,cr.complaint_sub,cr.complaint_details,cr.reply from complaint_reg cr,user u where u.email=cr.complaint_email");
   %>
